...
hl.curve("fast",           { type = "spring", mass = 1, stiffness = 128.2633, dampening = 85.8273644 })

hl.animation({ leaf = "global",        enabled = true,  speed = 2,   bezier = "default" })
hl.animation({ leaf = "border",        enabled = true,  speed = 5.39, bezier = "easeOutQuint" })
hl.animation({ leaf = "windows",       enabled = true,  speed = 1.75, bezier = "easeInOutCubic", style = "popin" })
-- hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 0.75, bezier = "fast", style = "slide" })
...
hl.animation({ leaf = "specialWorkspace",    enabled = true,  speed = 2.00, bezier = "almostLinear", style = "fade" })
