...
1. Request a free copy of Issue 9 at
...
| `word-index.tsv` | 1889 words. 582 approved. Columns: word, part of speech, approved, meaning or alternatives |
...
The word index is derived. Its meaning column truncates at 70 characters, and it
sometimes takes a term from the example column of the PDF. The text file is
authoritative. When the two disagree, use the text file.
